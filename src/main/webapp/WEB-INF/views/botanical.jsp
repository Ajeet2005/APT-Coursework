...
<c:set var="pageTitle" value="Botanical Shop &mdash; Gallery Artisan&rsquo;s" scope="request"/>
<%@ include file="/WEB-INF/views/includes/header.jsp" %>

<section class="page-hero botanical-hero">
    <span class="eyebrow">Shop &middot; Florals &amp; Still Life</span>
    ...
    <p>
        <c:choose>
            ...
            <c:otherwise>
                Hand-curated botanical paintings &mdash; museum-quality giclée prints, ready to ship worldwide.
            </c:otherwise>
        </c:choose>
    </p>
...
<section class="product-grid">
    <c:choose>
        ...
        <c:otherwise>
            <p class="empty">No products yet &mdash; once your database has artworks in the Botanical category they&rsquo;ll appear here.</p>
        </c:otherwise>
    </c:choose>
</section>
