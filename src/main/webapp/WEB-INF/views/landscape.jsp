...
<c:set var="pageTitle" value="Landscape Shop &mdash; Gallery Artisan&rsquo;s" scope="request"/>
<%@ include file="/WEB-INF/views/includes/header.jsp" %>

<section class="page-hero botanical-hero">
    <span class="eyebrow">Shop &middot; Mountains, Plains &amp; Skies</span>
    <h1>Landscape Collection</h1>
    <p>
        <c:choose>
            ...
            <c:otherwise>
                Mountains, fields and starlit skies &mdash; colour-forward landscapes that put nature centre-stage.
            </c:otherwise>
        </c:choose>
    </p>
...
<section class="product-grid">
    <c:choose>
        ...
        <c:otherwise>
            <p class="empty">No products yet &mdash; once your database has artworks in the Landscape category they&rsquo;ll appear here.</p>
        </c:otherwise>
    </c:choose>
</section>
