...
<c:set var="pageTitle" value="Portrait Shop &mdash; Gallery Artisan&rsquo;s" scope="request"/>
<%@ include file="/WEB-INF/views/includes/header.jsp" %>

<section class="page-hero botanical-hero">
    <span class="eyebrow">Shop &middot; Faces &amp; Figures</span>
    ...
    <p>
        <c:choose>
            ...
            <c:otherwise>
                Portraiture that celebrates texture and personality &mdash; faces rendered in colour, light and feeling.
            </c:otherwise>
        </c:choose>
    </p>
...
<section class="product-grid">
    <c:choose>
        ...
        <c:otherwise>
            <p class="empty">No products yet &mdash; once your database has artworks in the Portrait category they&rsquo;ll appear here.</p>
        </c:otherwise>
    </c:choose>
</section>
